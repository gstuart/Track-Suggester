$(document).ready(function() {
  ...
  //  $("#questions").show(); //this will display the form.
    ...
    $("#result").show("Based on your selections, you should go into the <bold><em>Java</bold></em> course! + #javaDscrptn");
    ...
    //       $("#result").show("Based on your selections, you should go into the <bold><em>Java</bold></em> course! + #javaDscrptn"); // display #result
    //       // display ("Based on your selections, you should go into the <bold><em>Java</bold></em> course. + #javaDscrptn")
    //
